...
public class DefaultSourcingResultHandler implements SourcingResultHandler
{
	 ...
	 *
	 * @see
	 * com.sap.retail.oaa.commerce.services.sourcing.SourcingResultHandler#persistSourcingResultInCart(com.sap.retail
	...
	public boolean hasSourcingResult(final SourcingResponse sourcing)
	{
		...
		if (sourcing.getSourcingResults().getSourcingResults().get(0).getCartItems().getSourcingResultCartItems() == null
			...
			final AvailabilityItemResponse availabilityItem)
	{
		...
		scheduleLine.setConfirmedQuantity(new Double(availabilityItem.getQuantity()));
	...
	protected PointOfServiceModel getPosForEntry(final String source) throws SourcingException
	{
