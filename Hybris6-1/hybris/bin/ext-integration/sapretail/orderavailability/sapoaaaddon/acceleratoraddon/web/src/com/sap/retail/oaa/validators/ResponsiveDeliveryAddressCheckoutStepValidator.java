...
public class ResponsiveDeliveryAddressCheckoutStepValidator extends AbstractCheckoutStepValidator
{
	...
	/**
	 * Performs Sourcing for actual session cart and redirects to the next checkout step.
	 *
	...
	/**
	 * Performs Sourcing for actual session cart and redirects to the corresponding checkout step.
	 *
	 * @param redirectAttributes
	 * @return ValidationResults
	 */
	...
	/**
	 * Performs Sourcing for pickup items in the actual session cart and redirects to the corresponding checkout step.
	 *
	 * @param redirectAttributes
	 * @return ValidationResults
	 */
