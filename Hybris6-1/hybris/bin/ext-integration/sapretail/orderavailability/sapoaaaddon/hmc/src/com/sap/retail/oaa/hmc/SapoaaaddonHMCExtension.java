 ...
 *
 */
package com.sap.retail.oaa.hmc;
...
/**
 * Provides necessary meta information about the sapoaaaddon hmc extension.
 *
 *
 * @version ExtGen v5.7.0.2
 */
public class SapoaaaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(SapoaaaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.sap.retail.oaa.hmc.locales";
