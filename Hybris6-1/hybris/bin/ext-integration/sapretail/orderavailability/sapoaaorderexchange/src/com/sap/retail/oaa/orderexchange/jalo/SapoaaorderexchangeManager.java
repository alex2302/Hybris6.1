 ...
 *
 */
package com.sap.retail.oaa.orderexchange.jalo;
...
/**
 * This is the extension manager of the Sapoaaorderexchange extension.
 */
public class SapoaaorderexchangeManager extends GeneratedSapoaaorderexchangeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapoaaorderexchangeManager.class.getName());
	 ...
	 */
	public SapoaaorderexchangeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapoaaorderexchangeManager called.");
		}
	}
	 ...
	 */
	public static SapoaaorderexchangeManager getInstance()
	{
		return (SapoaaorderexchangeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapoaaorderexchangeConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapoaaorderexchangeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapoaaorderexchangeManager called, current tenant: " + getTenant().getTenantID());
		}
	}
