...
public class SapoaacommercefacadesManager extends GeneratedSapoaacommercefacadesManager
{
	...
	{
		return (SapoaacommercefacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapoaacommercefacadesConstants.EXTENSIONNAME);
	}
