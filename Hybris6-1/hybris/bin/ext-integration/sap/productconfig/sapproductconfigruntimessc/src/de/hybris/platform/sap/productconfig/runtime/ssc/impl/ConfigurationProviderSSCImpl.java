...
public class ConfigurationProviderSSCImpl extends BaseConfigurationProviderSSCImpl
{
			...
			final ICsticHeader csticHeader) throws IpcCommandException
	{
		...
		csticModel.setStaticDomainLength(
				calculateStaticDomainLength(session, configId, csticData.getInstanceId(), csticHeader.getCsticName()));
		...
		for (final ICsticData csticData : csticsData)
		{
			...
			else
			{
				...
				for (final String groupName : groupNames)
				{
					...
					// group
					final Integer position = firstGroup ? positionInFirstGroup
							: Integer.valueOf(positionInInstance.intValue() + csticCount);
