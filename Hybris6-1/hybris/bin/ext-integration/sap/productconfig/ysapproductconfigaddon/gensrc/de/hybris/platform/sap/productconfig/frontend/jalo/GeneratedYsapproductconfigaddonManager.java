...
import de.hybris.platform.sap.productconfig.frontend.jalo.CMSConfigurableProductRestriction;
...
import de.hybris.platform.sap.productconfig.frontend.jalo.ProductConfigurationButtonComponent;
...
import de.hybris.platform.sap.productconfig.frontend.jalo.ProductConfigurationSpecificationComponent;
import de.hybris.platform.sap.productconfig.frontend.jalo.ProductConfigurationTabNavigationComponent;
...
public abstract class GeneratedYsapproductconfigaddonManager extends Extension
{
	...
	public CMSConfigurableProductRestriction createCMSConfigurableProductRestriction(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( SapproductconfigaddonConstants.TC.CMSCONFIGURABLEPRODUCTRESTRICTION );
	...
	public ProductConfigurationButtonComponent createProductConfigurationButtonComponent(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( SapproductconfigaddonConstants.TC.PRODUCTCONFIGURATIONBUTTONCOMPONENT );
	...
	public ProductConfigurationSpecificationComponent createProductConfigurationSpecificationComponent(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( SapproductconfigaddonConstants.TC.PRODUCTCONFIGURATIONSPECIFICATIONCOMPONENT );
	...
	public ProductConfigurationTabNavigationComponent createProductConfigurationTabNavigationComponent(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( SapproductconfigaddonConstants.TC.PRODUCTCONFIGURATIONTABNAVIGATIONCOMPONENT );
