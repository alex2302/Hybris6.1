	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20160615123110_commercesearch_artifact_release_6.1.0_3955d12/prepare/build/source/commercesearchatddtests/genresources/robottests/HeroProducts_Tests.txt"));
		}
