	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20160622160549_promotionengine_artifact_release_6.1.0_a072cb6/prepare/build/source/promotionengineatddtests/genresources/robottests/Coupon_Promotion_Rules.txt"));
		}
