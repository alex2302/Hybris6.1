	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/srv/jenkins/workspace/configurablebundles-module_release-6.1.0/source/configurablebundleatddtests/genresources/robottests/XML_Verification_BundleTemplate_Tests.txt"));
		}
