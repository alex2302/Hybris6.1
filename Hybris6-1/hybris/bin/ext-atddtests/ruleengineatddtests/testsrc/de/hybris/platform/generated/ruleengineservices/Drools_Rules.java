	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20160630152133_ruleengine_artifact_release_6.1.0_5ae6964/prepare/build/source/ruleengineatddtests/genresources/robottests/Drools_Rules.txt"));
		}
