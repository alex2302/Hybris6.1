	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20160623000405_commerceservices_artifact_develop_a868037/prepare/build/source/commerceservicesatddtests/genresources/robottests/Save_Cart_List.txt"));
		}
