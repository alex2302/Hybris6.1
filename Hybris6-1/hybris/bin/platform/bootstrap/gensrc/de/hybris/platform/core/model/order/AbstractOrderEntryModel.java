...
public class AbstractOrderEntryModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>AbstractOrderEntry.scheduleLines</code> attribute defined at extension <code>sapoaamodel</code>. */
	public static final String SCHEDULELINES = "scheduleLines";
	
	/** <i>Generated constant</i> - Attribute key of <code>AbstractOrderEntry.sapSource</code> attribute defined at extension <code>sapoaamodel</code>. */
	public static final String SAPSOURCE = "sapSource";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrderEntry.sapSource</code> attribute defined at extension <code>sapoaamodel</code>. 
	 * @return the sapSource - Result from Sourcing determination which will be sent to SAP ERP
	 */
	@Accessor(qualifier = "sapSource", type = Accessor.Type.GETTER)
	public PointOfServiceModel getSapSource()
	{
		return getPersistenceContext().getPropertyValue(SAPSOURCE);
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrderEntry.scheduleLines</code> attribute defined at extension <code>sapoaamodel</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the scheduleLines - Schedule Lines
	 */
	@Accessor(qualifier = "scheduleLines", type = Accessor.Type.GETTER)
	public List<ScheduleLineModel> getScheduleLines()
	{
		return getPersistenceContext().getPropertyValue(SCHEDULELINES);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrderEntry.sapSource</code> attribute defined at extension <code>sapoaamodel</code>. 
	 *  
	 * @param value the sapSource - Result from Sourcing determination which will be sent to SAP ERP
	 */
	@Accessor(qualifier = "sapSource", type = Accessor.Type.SETTER)
	public void setSapSource(final PointOfServiceModel value)
	{
		getPersistenceContext().setPropertyValue(SAPSOURCE, value);
	}
	
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrderEntry.scheduleLines</code> attribute defined at extension <code>sapoaamodel</code>. 
	 *  
	 * @param value the scheduleLines - Schedule Lines
	 */
	@Accessor(qualifier = "scheduleLines", type = Accessor.Type.SETTER)
	public void setScheduleLines(final List<ScheduleLineModel> value)
	{
		getPersistenceContext().setPropertyValue(SCHEDULELINES, value);
	}
