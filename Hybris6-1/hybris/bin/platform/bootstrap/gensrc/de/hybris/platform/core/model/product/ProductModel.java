...
public class ProductModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>Product.structuredArticleType</code> attribute defined at extension <code>saparticlemodel</code>. */
	public static final String STRUCTUREDARTICLETYPE = "structuredArticleType";
	
	/** <i>Generated constant</i> - Attribute key of <code>Product.discountable</code> attribute defined at extension <code>saparticlemodel</code>. */
	public static final String DISCOUNTABLE = "discountable";
	
	/** <i>Generated constant</i> - Attribute key of <code>Product.component</code> attribute defined at extension <code>saparticlemodel</code>. */
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.component</code> attribute defined at extension <code>saparticlemodel</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the component
	 */
	@Accessor(qualifier = "component", type = Accessor.Type.GETTER)
	public Collection<ArticleComponentModel> getComponent()
	{
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.discountable</code> attribute defined at extension <code>saparticlemodel</code>. 
	 * @return the discountable - Discountable
	 */
	@Accessor(qualifier = "discountable", type = Accessor.Type.GETTER)
	public Boolean getDiscountable()
	{
		return getPersistenceContext().getPropertyValue(DISCOUNTABLE);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Product.structuredArticleType</code> attribute defined at extension <code>saparticlemodel</code>. 
	 * @return the structuredArticleType - Article Type
	 */
	@Accessor(qualifier = "structuredArticleType", type = Accessor.Type.GETTER)
	public StructuredArticleType getStructuredArticleType()
	{
		return getPersistenceContext().getPropertyValue(STRUCTUREDARTICLETYPE);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Product.component</code> attribute defined at extension <code>saparticlemodel</code>. 
	 *  
	 * @param value the component
	 */
	@Accessor(qualifier = "component", type = Accessor.Type.SETTER)
	public void setComponent(final Collection<ArticleComponentModel> value)
	{
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Product.discountable</code> attribute defined at extension <code>saparticlemodel</code>. 
	 *  
	 * @param value the discountable - Discountable
	 */
	@Accessor(qualifier = "discountable", type = Accessor.Type.SETTER)
	public void setDiscountable(final Boolean value)
	{
		getPersistenceContext().setPropertyValue(DISCOUNTABLE, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Product.structuredArticleType</code> attribute defined at extension <code>saparticlemodel</code>. 
	 *  
	 * @param value the structuredArticleType - Article Type
	 */
	@Accessor(qualifier = "structuredArticleType", type = Accessor.Type.SETTER)
	public void setStructuredArticleType(final StructuredArticleType value)
	{
		getPersistenceContext().setPropertyValue(STRUCTUREDARTICLETYPE, value);
	}
