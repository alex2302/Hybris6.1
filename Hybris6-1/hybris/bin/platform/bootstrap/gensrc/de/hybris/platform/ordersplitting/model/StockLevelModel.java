...
public class StockLevelModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>StockLevel.sapoaa_roughStockIndicator</code> attribute defined at extension <code>sapoaamodel</code>. */
	public static final String SAPOAA_ROUGHSTOCKINDICATOR = "sapoaa_roughStockIndicator";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>StockLevel.sapoaa_roughStockIndicator</code> attribute defined at extension <code>sapoaamodel</code>. 
	 * @return the sapoaa_roughStockIndicator - Rough Stock Indicator
	 */
	@Accessor(qualifier = "sapoaa_roughStockIndicator", type = Accessor.Type.GETTER)
	public String getSapoaa_roughStockIndicator()
	{
		return getPersistenceContext().getPropertyValue(SAPOAA_ROUGHSTOCKINDICATOR);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>StockLevel.sapoaa_roughStockIndicator</code> attribute defined at extension <code>sapoaamodel</code>. 
	 *  
	 * @param value the sapoaa_roughStockIndicator - Rough Stock Indicator
	 */
	@Accessor(qualifier = "sapoaa_roughStockIndicator", type = Accessor.Type.SETTER)
	public void setSapoaa_roughStockIndicator(final String value)
	{
		getPersistenceContext().setPropertyValue(SAPOAA_ROUGHSTOCKINDICATOR, value);
	}
