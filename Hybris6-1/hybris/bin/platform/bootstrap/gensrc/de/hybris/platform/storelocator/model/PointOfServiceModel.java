...
public class PointOfServiceModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>PointOfService.sapoaa_cacShippingPoint</code> attribute defined at extension <code>sapoaamodel</code>. */
	public static final String SAPOAA_CACSHIPPINGPOINT = "sapoaa_cacShippingPoint";
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>PointOfService.sapoaa_cacShippingPoint</code> attribute defined at extension <code>sapoaamodel</code>. 
	 * @return the sapoaa_cacShippingPoint - Shipping Point for Click and Collect
	 */
	@Accessor(qualifier = "sapoaa_cacShippingPoint", type = Accessor.Type.GETTER)
	public String getSapoaa_cacShippingPoint()
	{
		return getPersistenceContext().getPropertyValue(SAPOAA_CACSHIPPINGPOINT);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>PointOfService.sapoaa_cacShippingPoint</code> attribute defined at extension <code>sapoaamodel</code>. 
	 *  
	 * @param value the sapoaa_cacShippingPoint - Shipping Point for Click and Collect
	 */
	@Accessor(qualifier = "sapoaa_cacShippingPoint", type = Accessor.Type.SETTER)
	public void setSapoaa_cacShippingPoint(final String value)
	{
		getPersistenceContext().setPropertyValue(SAPOAA_CACSHIPPINGPOINT, value);
	}
