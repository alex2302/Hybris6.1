 ...
 */
angular.module('componentMenuModule', ['componentsModule', 'componentServiceModule', 'assetsServiceModule'])
    .controller('ComponentMenuController', function($log, ComponentService) {
        ...
        self.loadComponentItems = function() {
            ...
            ComponentService.loadComponentItems().then(function(response) {
                self.visibleItems.componentItems = response.componentItems;
            });
        };
     ...
     */
    .directive('componentMenu', function($rootScope, systemEventService, $q, $document, assetsService) {
        return {
